package com.pardorafaela.microservicemeetup.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.pardorafaela.microservicemeetup.controller.dto.RegistrationDTO;
import com.pardorafaela.microservicemeetup.controller.resource.RegistrationController;
import com.pardorafaela.microservicemeetup.exception.BusinessException;
import com.pardorafaela.microservicemeetup.model.entity.Registration;
import com.pardorafaela.microservicemeetup.service.RegistrationService;
...
public class RegistrationControllerTest {
    ...
    public void getRegistrationTest() throws Exception {
        ...
        Registration registration = Registration.builder()
                ...
                .dateOfRegistration(String.valueOf(createNewRegistration().getDateOfRegistration()))
    ...
    private RegistrationDTO createNewRegistration() {
        return  RegistrationDTO.builder().id(Long.valueOf(101)).name("Ana Neri").dateOfRegistration(LocalDateTime.parse("10/10/2021")).registration("001").build();
    }
}